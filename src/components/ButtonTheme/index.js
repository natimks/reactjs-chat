...
const ButtonTheme = ({ theme, themeMode, toggleTheme }) => {
  return (
    <Button onClick={toggleTheme} themeMode={themeMode}>
      {theme === 'light' ? (
        <Moon xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'>
          <path
            style={{ fill: themeMode.text }}
        ...
        <Sun xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'>
          <path
            style={{ fill: themeMode.text }}
